...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Provider widget is used for state management
    // sets a value globally which can be used anywhere in the project
    // CartProvider is a user-created global provider from where we can access product
    // and add it to cart in productDetailsPage() on click of addToCart button
